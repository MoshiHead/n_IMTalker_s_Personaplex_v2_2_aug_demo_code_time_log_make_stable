...
exec env \
  ...
  PERSONAPLEX_TEMP="${PERSONAPLEX_TEMP-}" \
  PERSONAPLEX_TEMP_TEXT="${PERSONAPLEX_TEMP_TEXT-}" \
  PERSONAPLEX_TOP_K="${PERSONAPLEX_TOP_K-}" \
  PERSONAPLEX_TOP_K_TEXT="${PERSONAPLEX_TOP_K_TEXT-}" \
